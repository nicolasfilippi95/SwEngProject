...
public class ServizioSomma implements IServizio{
	...
	public ServizioSomma()
	{
		//Random r = new Random();
		//String sIp = 127+"."+r.nextInt(254)+"."+r.nextInt(254)+"."+r.nextInt(253); //253 per evitare l'indirizzo di broadcast
		//ip = sIp;
	}
	public ServizioSomma(String pFI, String pFO, String pProprietario, String pSettore, 
...
id=pId;
	...
	public String eseguiServizio(String parametri)
	{
		...
		int somma= num1+num2;
		String risultato= Integer.toString(somma);
		return risultato;
	}
